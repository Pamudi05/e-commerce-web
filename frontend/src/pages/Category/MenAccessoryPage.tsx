...
function MenAccessoryPage({ searchText }: AllCategoryProps) {
  ...
  const menAccessory = products.filter(
    (product) => product.category === "Men Accessory"
  );
...
export default MenAccessoryPage;
